  ...
  <ion-page>
    ...
    <ion-content>
        <div class="body">        
            ...
            <!-- Input for user's email address to allow password reset -->
            <ion-input type="text" v-model="email" class="box" color="light" placeholder="Email" clearInput="true"></ion-input>
            <p></p>
            <!-- Button to activate the resetPassword method -->
